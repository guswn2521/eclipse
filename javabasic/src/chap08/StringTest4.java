...
public class StringTest4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("3번 인덱스부터 5번 인덱스 문자가지 출력 : source1.substring(3,6) :" + source1.substring(3,6));
		...
		System.out.println("source1 문자열이 aaa 문자열로 시작하는지 확인 : source1.startsWith(\"aaa\") : " + source1.startsWith("aaa"));
		System.out.println("source1 문자열에 aaa 문자열이 포함되어 있는지를 판단 : " + "source1.contains(\"aaa\") : " + source1.contains("aaa"));
		System.out.println("souce1 문자열의 길이 : source1.length() : " + source1.length());
